...
Ext.ux.form.DateTime = Ext.extend(Ext.form.Field, {
    ...
    /**
     * @cfg {Boolean} useFullWidth If true then the date input field expands so that together with the time field they
     * use up the whole line. If false the date field is as large as a date field alone.
     * Note that it does not have any effect if timePosition is set to 'below': still both fields use the max available
     * width.
     */
    ,useFullWidth: true
    /**
    ...
    ,initComponent:function() {
        ...
        if (this.useFullWidth) dateConfig.width = this.timeWidth;
...
// register xtype
Ext.define( 'xdatetime', 'Ext.ux.form.DateTime' );
