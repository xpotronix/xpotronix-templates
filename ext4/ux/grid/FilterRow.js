  ...
  init: function(grid) {
    ...
    var view = grid.getView();
		...
		this.menu.on('click', function() {
			...
			if ( ! this.search_bar_div )
				this.search_bar_div = Ext.get( this.grid.id + '_search_bar' );

			if ( this.search_bar_div )
				this.search_bar_div.dom.style.display = this.shown ? '' : 'none';
...
Ext.define( 'Ext.ux.grid.FilterRowFilter', {
