...
<!-- paneles por tipo -->
	...
	<xsl:template match="panel[@type='xpPanel']"><!--{{{-->
		...
		<xsl:if test="position()-1">,</xsl:if>Ext.define( 'Ux.xpotronix.xpPanel', Ext.apply(
	...
	<xsl:template match="panel[@type='xpForm']"><!--{{{-->
		...
		<xsl:if test="position()-1">,</xsl:if>Ext.define( 'Ux.xpotronix.xpForm', Ext.apply(
		<xsl:apply-templates select="." mode="panel_config"><xsl:with-param name="obj" select="$obj/obj" tunnel="yes"/></xsl:apply-templates>
		,<xsl:apply-templates select="." mode="panel_config_override"><xsl:with-param name="obj" select="$obj/obj" tunnel="yes"/></xsl:apply-templates>
	...
	<xsl:template match="panel[@type='Form']"><!--{{{--> 
		...
		<xsl:if test="position()-1">,</xsl:if>Ext.define( 'Ext.form.FormPanel', Ext.apply(
	...
	<xsl:template match="panel[@type='xpData']"><!--{{{-->
		...
		<xsl:if test="position()-1">,</xsl:if>Ext.define( 'Ux.xpotronix.xpData', Ext.apply(
		<xsl:apply-templates select="." mode="panel_config"><xsl:with-param name="obj" select="$obj/obj" tunnel="yes"/></xsl:apply-templates>
		,<xsl:apply-templates select="." mode="panel_config_override"><xsl:with-param name="obj" select="$obj/obj" tunnel="yes"/></xsl:apply-templates>
	...
	<xsl:template match="panel[@type='xpThumbs']"><!--{{{-->
		...
		<xsl:if test="position()-1">,</xsl:if>Ext.define( 'Ux.xpotronix.xpThumbs', Ext.apply(
		<xsl:apply-templates select="." mode="panel_config"><xsl:with-param name="obj" select="$obj/obj" tunnel="yes"/></xsl:apply-templates>
		,<xsl:apply-templates select="." mode="panel_config_override"><xsl:with-param name="obj" select="$obj/obj" tunnel="yes"/></xsl:apply-templates>
	...
	<xsl:template match="panel[@type='Tab']"><!--{{{-->
		...
		<xsl:if test="position()-1">,</xsl:if>Ext.define( 'Ext.TabPanel', Ext.apply(
		<xsl:apply-templates select="." mode="panel_config"><xsl:with-param name="obj" select="$obj/obj" tunnel="yes"/></xsl:apply-templates>
		,<xsl:apply-templates select="." mode="panel_config_override"><xsl:with-param name="obj" select="$obj/obj" tunnel="yes"/></xsl:apply-templates>
	...
	<xsl:template match="panel[@type='Viewport']"><!--{{{-->
		...
		<xsl:if test="position()-1">,</xsl:if>Ext.define( 'Ext.Viewport', Ext.apply(
		<xsl:apply-templates select="." mode="panel_config"><xsl:with-param name="obj" select="$obj/obj" tunnel="yes"/></xsl:apply-templates>
		,<xsl:apply-templates select="." mode="panel_config_override"><xsl:with-param name="obj" select="$obj/obj" tunnel="yes"/></xsl:apply-templates>
	...
	<xsl:template match="panel[@type='Window']"><!--{{{-->
		...
		<xsl:if test="position()-1">,</xsl:if>Ext.define( 'Ext.Window', Ext.apply(
		<xsl:apply-templates select="." mode="panel_config"><xsl:with-param name="obj" select="$obj/obj" tunnel="yes"/></xsl:apply-templates>
		,<xsl:apply-templates select="." mode="panel_config_override"><xsl:with-param name="obj" select="$obj/obj" tunnel="yes"/></xsl:apply-templates>
		,{
			width: 300
	...
	<xsl:template match="panel[@type='xpUploadPanel']"><!--{{{-->
		...
		<xsl:if test="position()-1">,</xsl:if>Ext.define( 'Ux.xpotronix.xpUploadPanel', Ext.apply(
		<xsl:apply-templates select="." mode="panel_config"><xsl:with-param name="obj" select="$obj/obj" tunnel="yes"/></xsl:apply-templates>
...
<!-- cmp -->
	...
	<xsl:template match="cmp[not(@ref)]" mode="sub"><!--{{{-->
		...
		Ext.define( '<xsl:value-of select="$panel_type"/>', {
